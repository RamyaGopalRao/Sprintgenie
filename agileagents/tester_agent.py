...
tester_agent = Agent(
    name="TesterAgent",
<<<<<<< HEAD
    instructions=load_instructions("tester_instructions.txt"),
=======
    instructions="""You are a Senior QA Engineer and Testing Specialist with expertise in writing comprehensive unit tests, integration tests, and test automation.
